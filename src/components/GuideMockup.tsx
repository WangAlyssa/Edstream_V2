  ...
  <div className="flex h-full flex-col">
    ...
    <div className="grid min-h-0 flex-1 grid-cols-[22%_1fr]">
      ...
      <main className="flex flex-col p-3">
        <p className="mb-2 text-[9px] font-bold text-gray-700">Switch between course workspaces</p>
        <div className="grid flex-1 grid-cols-3 gap-2 text-center text-[8px] text-gray-500">
