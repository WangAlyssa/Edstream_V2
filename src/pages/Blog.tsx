    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="py-16 -mt-10 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-blue dark:text-blue-300 mb-4">Featured Guide</h2>
          </div>

          <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-orange dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-blue dark:text-blue-300 mb-4 hover:text-orange transition-colors">
                    {featuredGuide.title}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-6">{featuredGuide.overview}</p>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-blue dark:text-blue-300 mb-4">Step-by-Step Guides</h2>
          ...
          <div className="mx-auto mb-10 grid max-w-md grid-cols-2 rounded-2xl bg-white dark:bg-gray-900 p-2 shadow-lg border border-gray-100 dark:border-gray-700">
            {[
          ...
          <div className="flex flex-col gap-4">
            {visibleGuides.map((guide, index) => (
              <Link key={guide.id} to={`/guides/${guide.id}`} className="group block">
                <div className="flex aspect-[16/3] min-h-[88px] items-center gap-5 rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 shadow-lg transition-all duration-300 group-hover:-translate-y-0.5 group-hover:shadow-2xl sm:gap-8 sm:px-8">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-lg font-bold text-blue dark:text-blue-300 sm:text-xl group-hover:text-orange transition-colors">
                      {guide.title}
                    </h3>
                    <p className="mt-1 truncate text-sm text-gray-600 dark:text-gray-300 sm:text-base">{guide.description}</p>
                  </div>
