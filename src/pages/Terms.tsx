      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">Agreement to Terms</h2>
                </div>
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">Description of Service</h2>
                </div>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">EdStream Platform</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Educational Purpose</h3>
                    <p className="text-gray-600 leading-relaxed">
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">User Accounts and Access</h2>
                </div>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Account Creation</h3>
                    <p className="text-gray-600">EdStream accounts are created through Canvas LMS integration. Users access EdStream using their existing Canvas credentials and do not need separate account registration.</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Authorized Use</h3>
                    <p className="text-gray-600 mb-2">EdStream access is limited to:</p>
                    <ul className="list-disc list-inside text-gray-600 space-y-1">
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">Acceptable Use Policy</h2>
                </div>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Permitted Uses</h3>
                    <p className="text-gray-600 mb-2">EdStream may be used for:</p>
                    <ul className="list-disc list-inside text-gray-600 space-y-1">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Academic Integrity</h3>
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">Prohibited Activities</h2>
                </div>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">Privacy and Data Protection</h2>
                </div>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Data Collection and Use</h3>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Participating educational institutions and the University of Florida Research Foundation may access user data and communications as permitted by institutional policies, University of Florida policies, and applicable laws.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                <h2 className="text-2xl font-bold text-blue mb-6">Service Availability</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">EdStream reserves the right to modify features and functionality with appropriate notice, update terms of service, and implement new security measures.</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">Technical Support</h3>
                    <p className="text-gray-600 text-sm">EdStream provides technical support to participating institutions and their users according to service level agreements with each institution.</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">User License</h3>
                    <p className="text-gray-600 text-sm">The University of Florida Research Foundation grants users a limited, non-exclusive, non-transferable license to use the platform solely for educational purposes.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                <h2 className="text-2xl font-bold text-blue mb-6">Intellectual Property</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <Card>
              <CardContent className="p-8">
                <h2 className="text-2xl font-bold text-blue mb-6">Limitation of Liability</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <Card>
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-blue">Compliance and Regulatory Matters</h2>
                </div>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-blue mb-2">University of Florida Compliance</h3>
                    <p className="text-gray-600 mb-2">As a University of Florida Research Foundation project, EdStream adheres to all University of Florida compliance requirements, including:</p>
                    <ul className="list-disc list-inside text-gray-600 space-y-1">
            ...
            <Card className="border-l-4 border-l-orange">
              <CardContent className="p-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-blue mb-4">Contact Information</h2>
                    <div className="bg-white rounded-lg shadow-sm border p-8">
                      <h2 className="text-2xl font-bold text-blue mb-6">Contact Information</h2>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                          <h3 className="text-lg font-semibold text-blue mb-4">Terms Questions</h3>
                          <p className="text-gray-600 mb-4">For questions about these Terms of Service, contact:</p>
                          <p className="text-gray-700 mb-2">
                            <strong>Email:</strong> <a href="mailto:legal@edstream.io" className="text-blue hover:text-orange transition-colors">legal@edstream.io</a>
                          </p>
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-blue mb-4">Reporting Violations</h3>
                          <p className="text-gray-600 mb-4">To report violations of these terms:</p>
                          <p className="text-gray-700">
                            <strong>Email:</strong> <a href="mailto:violations@edstream.io" className="text-blue hover:text-orange transition-colors">violations@edstream.io</a>
                          </p>
                        </div>
                      </div>
                    </div>
